...
const (
	...
	endpointSimulatePmtC2B            = "/mpesa/c2b/v1/simulate"                           // The endpoint for simulating a C2B transaction
	...
	endpointRegisterConfirmValidation = "/mpesa/c2b/v1/registerurl"                        // The endpoint for confirming a C2B transaction
)
